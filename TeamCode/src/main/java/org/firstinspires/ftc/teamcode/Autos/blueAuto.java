...
@Config
@Autonomous(name = "blue lmao", group = "Autonomous")
public class blueAuto extends AutonFunctions {
    ...
    public void runOpMode() {
        ...
        Action intakeSecondSet = drive.actionBuilder(new Pose2d(new Vector2d(-20, -20), Math.toRadians(-135)))
                .setTangent(45)
                .splineToLinearHeading(new Pose2d(14, -15, Math.toRadians(-90)), Math.toRadians(-90))
                .setTangent(Math.toRadians(-90))
                .splineToConstantHeading(new Vector2d(14, -70), Math.toRadians(-90))
                .waitSeconds(0.1)
                .build();

        Action goToScoreSecondSet = drive.actionBuilder(new Pose2d(14, -70, Math.toRadians(-90)))
                .setTangent(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(-20, -20, Math.toRadians(-135)), Math.toRadians(-135))
                .build();
